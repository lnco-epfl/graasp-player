export const PLAYER = {
  ...
  AUTO_LOGIN_NO_ITEM_LOGIN_ERROR: 'AUTO_LOGIN_NO_ITEM_LOGIN_ERROR',
  AUTO_LOGIN_ALREADY_LOGGED_IN: 'AUTO_LOGIN_ALREADY_LOGGED_IN',
  AUTO_LOGIN_SIGN_OUT_AND_BACK_IN: 'AUTO_LOGIN_SIGN_OUT_AND_BACK_IN',
  AUTO_LOGIN_GO_TO_HOME: 'AUTO_LOGIN_GO_TO_HOME',
  AUTO_LOGIN_WELCOME_TITLE: 'AUTO_LOGIN_WELCOME_TITLE',
  AUTO_LOGIN_START_BUTTON: 'AUTO_LOGIN_START_BUTTON',
